        ...
        master_pages=[
            MasterPageSpec(
                ...
                elements=[
                    ...
                    MasterElementSpec(
                        type="rule", x_mm=14, y_mm=54, width_mm=271, height_mm=0.8, style_id="section_rule"
                    ),
                    MasterElementSpec(
                        type="folio",
                        x_mm=14,
                        ...
                        height_mm=6,
                        style_id="folio",
                        text="{publication_name} • {edition_date} • {page_number}",
                    ),
                ],
            ),
            MasterPageSpec(
                ...
                elements=[
                    ...
                    MasterElementSpec(
                        type="rule", x_mm=14, y_mm=22, width_mm=271, height_mm=0.5, style_id="section_rule"
                    ),
                    MasterElementSpec(
                        type="folio",
                        x_mm=14,
                        ...
                        height_mm=6,
                        style_id="folio",
                        text="{page_number} • {publication_name} • {edition_date}",
                    ),
                ],
            ),
        ],
        ...
        master_pages=[
            MasterPageSpec(
                ...
                elements=[
                    ...
                    MasterElementSpec(
                        type="rule", x_mm=14, y_mm=50, width_mm=252, height_mm=1.2, style_id="section_rule"
                    ),
                    MasterElementSpec(
                        type="folio",
                        x_mm=14,
                        ...
                        height_mm=6,
                        style_id="folio",
                        text="{publication_name} • {page_number}",
                    ),
                ],
            ),
            MasterPageSpec(
