...
VIDEO_FORMATS = [
    ...
    _video(
        ...
        duration=90,
        safe=VERTICAL_SOCIAL_SAFE,
        aliases=("ig_reel", "reels", "instagram_reels"),
        notes="Up to 90 seconds; the caption and buttons sit over the bottom fifth.",
    ),
    _video(
        "youtube_short",
        "YouTube short",
        ...
        duration=60,
        safe=VERTICAL_SOCIAL_SAFE,
        aliases=("shorts", "youtube_shorts"),
        notes="Up to 60 seconds.",
    ),
    _video(
        "tiktok_video",
        "TikTok video",
