...
STOPWORDS_FA = {
    "از", "به", "با", "برای", "که", "این", "آن", "را", "در", "و", "یا", "تا", "بر", "هم",
    "است", "بود", "شد", "شده", "می", "های", "ها", "یک", "خود", "هر", "نیز", "اما", "اگر",
    "دیگر", "کرد", "کند", "کرده", "باید", "چون", "وی", "او", "ما", "شما", "آنها", "روی",
    "بین", "طور", "همه", "بیش", "کمتر", "بیشتر", "درباره", "توسط", "پس", "قبل", "بعد",
}

STOPWORDS_EN = {
    "the", "and", "for", "that", "with", "this", "from", "have", "has", "was", "were",
    "are", "but", "not", "you", "all", "his", "her", "its", "they", "them", "will",
    "would", "could", "should", "been", "into", "than", "then", "there", "their",
